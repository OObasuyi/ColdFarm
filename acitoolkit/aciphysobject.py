...
#                                                                              #
################################################################################
"""aci_mod Toolkit module for physical objects
"""
import copy
import logging
...
class ExternalSwitch(BaseACIPhysObject):
    ...
    aci_mod nodes, i.e. are not under control of the APIC.
    ...
    about aci_mod nodes.  Nearly all of the information used
