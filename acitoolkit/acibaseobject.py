...
################################################################################
"""
This module implements the Base Class for creating all of the aci_mod Objects.
"""
import logging
...
class BaseACIObject(AciSearch):
    """
    This class defines functionality common to all aci_mod objects.
    ...
    def find(self, search_object):
        ...
        :param search_object: aci_mod object to search
        :returns:  List of objects
        """
        result = []
        match = True
